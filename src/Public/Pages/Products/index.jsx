...
const Products = () => {
    ...
    useEffect(() => {
        if (selectedProduct) {
            const filteredProducts = selectedProduct.filter(
                (filterProduct) => filterProduct.id == id
            );
    ...
    // console.log([...productDetail][0].images[0].url);
    //   const addToCart = (e) => {
    //     e.preventDefault();
    ...
    let colors = [];
    if (productDetail[0]) {
        sizes = productDetail[0].colorSizes.map((item) => item.size_name);
        colors = productDetail[0].colorSizes.map((item) => ({color_name:item.color_name,id:item.id}));
        console.log(colors)
    }
    return (
        <>
            ...
            {!productIsReady && !productDetail[0] && <Loader />}
            {productIsReady && productDetail[0] && (
                        ...
                        <div className="lg:grid lg:grid-cols-2 lg:items-start lg:gap-x-8">
                            ...
                            >
                                                    ...
                                                    {({ selected }) => (
                                                        <>
                                                            ...
                                                            <span className="absolute inset-0 overflow-hidden rounded-md">
                                                                <img
                                                                    src={`http://127.0.0.1:8000/${images.url}`}
                                                                    alt="image"
                                ...
                                <Tab.Panels className="aspect-w-1 aspect-h-1 w-full">
                                    {productDetail[0].images.map((images) => (
                                        <Tab.Panel key={images.url}>
                                            <img
                                                src={`http://127.0.0.1:8000/${images.url}`}
                                                alt={images.url}
                            ...
                            <div className="mt-10 px-4 sm:mt-16 sm:px-0 lg:mt-0">
                                ...
                                <form className="mt-6">
                                    ...
                                    <div className="sm:flex-col1 mt-10 flex">
                                        <button
                                            type="submit"
                                            className="flex max-w-xs flex-1 items-center justify-center rounded-md border border-transparent bg-black py-3 px-8 text-base font-medium text-white hover:bg-light-blue focus:outline-none focus:ring-2 focus:ring-green focus:ring-offset-2 focus:ring-offset-gray-50 sm:w-full"
